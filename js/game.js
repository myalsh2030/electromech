...
export const LEVELS = [
  { at: 0,    rank: 'شرارة أولى',       icon: '⚡' },
  { at: 100,  rank: 'مساعد فني',        icon: '🔧' },
  { at: 250,  rank: 'فني توصيلات',      icon: '🔌' },
  { at: 500,  rank: 'قارئ اللوحات',     icon: '📋' },
  { at: 900,  rank: 'صائد الأعطال',     icon: '🔍' },
  { at: 1400, rank: 'خبير اللوحات',     icon: '🏭' },
  { at: 2000, rank: 'أسطورة الكهرباء',  icon: '🏆' },
];

// {{THEME: سمِّ الرتب بروح تخصص المقرر}}
export const BADGES = [
